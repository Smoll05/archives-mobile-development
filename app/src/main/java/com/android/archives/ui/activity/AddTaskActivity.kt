...
@AndroidEntryPoint
class AddTaskActivity : AppCompatActivity(), EmojiPickerDialogueFragment.EmojiPickerListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnAdd = findViewById<Button>(R.id.add_task_button)
        etTaskTitle = findViewById(R.id.add_task_title)
        etTaskDescription = findViewById(R.id.add_task_desc)
        btnEmoji = findViewById(R.id.add_task_emoji_button)

        tilTitle = findViewById(R.id.add_task_layout)
        tilDesc = findViewById(R.id.add_task_desc_layout)
        ...
        val toolBar = findViewById<MaterialToolbar>(R.id.add_task_dialog_toolbar)
